...
import { mockTokens, mockUser } from '../mocks';
...
describe('AuthController', () => {
    ...
    describe('signUp', () => {
        it('should sign up a new user', async () => {
            ...
            jest.spyOn(authService, 'signUp').mockResolvedValue({ user: mockUser, tokens: mockTokens });
            ...
            expect(authService.setTokensCookies).toHaveBeenCalledWith(responseMock, mockTokens);
            expect(responseMock.status).toHaveBeenCalledWith(HttpStatus.CREATED);
            expect(responseMock.json).toHaveBeenCalledWith(plainToClass(User, mockUser));
        });
    });
    ...
    describe('signIn', () => {
        it('should sign in a user', async () => {
            ...
            jest.spyOn(authService, 'signIn').mockResolvedValue({ user: mockUser, tokens: mockTokens });
    ...
    describe('refreshAccess', () => {
        ...
        it('should throw an error if refresh token is not found', async () => {
            ...
            await expect(authController.refreshAccess(responseMock, requestMock)).rejects.toThrow(UnauthorizedException);
