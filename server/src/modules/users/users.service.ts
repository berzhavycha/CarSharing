...
export class UsersService {
    ...
    async createUser(userData: {
        ...
        const { userDetails, passwordHash, passwordSalt, refreshTokenHash, refreshTokenSalt } = userData

        let role = await this.rolesRepository.findOne({ where: { name: userDetails.role } });
